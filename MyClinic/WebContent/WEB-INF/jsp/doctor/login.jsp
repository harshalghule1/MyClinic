...
<html>
	...
	<body>
		<div class="header" id="home">
			...
			<h1>Login Here</h1>
			<br>
			Enter username<input type="text" name="username" id ="username"  required="required">
			<br>
			Enter password<input type="password" name="password" id="password" required="required"> 
			<br>
